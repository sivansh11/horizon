...
void log_t::set_log_level(log_level_t level) {
    _log_level = level;
}

void log_t::set_trace_color(const std::string& str) {
    _log_colors[0] = str;
}

void log_t::set_info_color(const std::string& str) {
    _log_colors[1] = str;
}

void log_t::set_warn_color(const std::string& str) {
    _log_colors[2] = str;
}

void log_t::set_error_color(const std::string& str) {
    _log_colors[3] = str;
}
