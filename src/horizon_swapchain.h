#ifndef HORIZON_SWAPCHAIN_H
#define HORIZON_SWAPCHAIN_H
...
class HorizonSwapChain {
 public:
  ...
  void operator=(const HorizonSwapChain &) = delete;
  ...
  bool compareSwapFormats(const HorizonSwapChain& swapChain) {
