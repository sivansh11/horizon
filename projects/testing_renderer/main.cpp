...
int main() {
    ...
    auto vertex_shader = renderer.context.create_shader({ .code = test_vertex, .name = "test vertex", .type = gfx::shader_type_t::e_vertex});
    auto fragment_shader = renderer.context.create_shader({ .code = test_fragment, .name = "test fragment", .type = gfx::shader_type_t::e_fragment});
    ...
    auto swapchain_vertex_shader = renderer.context.create_shader({ .code = swapchain_vertex, .name = "swapchain vertex", .type = gfx::shader_type_t::e_vertex});
    auto swapchain_fragment_shader = renderer.context.create_shader({ .code = swapchain_fragment, .name = "swapchain fragment", .type = gfx::shader_type_t::e_fragment});
