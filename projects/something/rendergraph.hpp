...
struct resource_builder_t {
    ...
    resource_t is_image(gfx::handle_image_t handle_image, gfx::handle_image_view_t handle_image_view);
...
using task_callback_t = std::function<void(renderer::base_renderer_t&)>;
